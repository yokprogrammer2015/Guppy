...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ url('clear/list') }}" method="post">
                    {{ csrf_field() }}
                    <div class="box-body">
                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                        ...
                        @foreach($order as $k => $row)
                            ...
                            <tr role="row">
                                <td>{{ $k+1 }}</td>
                                <td>@if($row->invoiceDetail){{ $row->invoiceDetail->inv_no }}@endif</td>
    ...
    <form role="form" id="getReport" action="{{ url('daily/credit/report') }}" method="post" target="_blank">
        ...
        <input type="hidden" name="type_name" id="type_name" value="Clear Credit">

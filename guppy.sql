...
CREATE TABLE `agent` (
  ...
  `ag_address` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `ag_phone` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ag_mobile` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ag_fax` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ag_status` int(1) NOT NULL,
...
INSERT INTO `agent` (`ag_id`, `branch_id`, `ag_name`, `ag_email`, `ag_address`, `ag_phone`, `ag_mobile`, `ag_fax`, `ag_status`, `creation_date`, `last_update`) VALUES
(1, 3, 'One2Go', '2mocyc@gmail.com', '233/23', '1111111', '2222222', '3333333', 0, '2018-08-06 02:29:19', '2018-08-13 08:18:45'),
(2, 2, 'Direc Ferry', 'admin@andamanwaveferry.com', '11/4', '0991808558', '0991808558', '021111111', 0, '2018-08-06 02:41:00', '2018-08-13 08:18:36'),
(3, 1, 'PooNa', 'PooNa@info.com', 'KS', '02-234-5678', '098-765-4321', '-', 0, '2018-08-16 07:27:31', '2018-08-16 07:27:31'),
(4, 2, 'Ban Bar', 'Banbar@info.com', 'KS', '02-123', '098-765', '-', 0, '2018-08-16 07:30:02', '2018-08-16 07:30:02'),
(5, 6, 'Phangan Boat', 'png@o.com', 'PNG', '+66', '+66', '+66', 0, '2018-08-16 07:41:13', '2018-08-16 07:41:13'),
(6, 2, '24 Travel', '24@o.com', '99 KS', '-', '-', '-', 0, '2018-08-16 08:26:18', '2018-08-16 08:32:08');
...
(4, 'กรุงไทย', 'KTB', '2018-08-13 09:04:28', '2018-08-13 09:04:28'),
(5, 'กรุงศรีอยุธยา', 'BAY', '2018-08-13 09:04:54', '2018-08-13 09:04:54'),
(6, 'ทหารไทย', 'TMB', '2018-08-13 09:05:10', '2018-08-13 09:05:10'),
(7, 'ออมสิน', 'GSB', '2018-08-13 09:05:24', '2018-08-13 09:05:24');
...
(4, 2, 'Chumphon', '029772084', '085555555', '025555555', '2018-08-13 08:42:24', '2018-08-15 02:38:16'),
(5, 3, 'Koh Tao', '', '', '', '2018-08-13 08:42:42', '2018-08-13 08:42:42'),
(6, 4, 'Koh Phangan', '', '', '', '2018-08-13 08:42:58', '2018-08-13 08:42:58'),
(7, 5, 'Koh Samui', '', '', '', '2018-08-13 08:43:12', '2018-08-13 08:43:12'),
(8, 7, 'Suratthani', '077-289-894', '', '077-289-894', '2018-08-13 08:43:42', '2018-08-16 08:29:27'),
(9, 7, 'Suratthani Airport', '', '', '', '2018-08-13 08:44:07', '2018-08-13 08:47:11'),
(10, 7, 'Donsak', '', '', '', '2018-08-13 08:44:20', '2018-08-13 08:46:23'),
(11, 7, 'Suratthani Train', '', '', '', '2018-08-13 08:44:39', '2018-08-13 08:46:10'),
(12, 7, 'Suratthani Town', '', '', '', '2018-08-13 08:45:05', '2018-08-13 08:45:05'),
...
CREATE TABLE `member` (
  ...
  `mb_email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `mb_password` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `id_card` varchar(13) COLLATE utf8_unicode_ci NOT NULL,
  `mb_status` int(1) NOT NULL,
  `creation_date` datetime NOT NULL,
  `last_update` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `order` (
  ...
  `pic3` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `creation_date` datetime NOT NULL,
  `last_update` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `agent`
  MODIFY `ag_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `member`
  MODIFY `mb_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
